...
## Repository map
- `bsuid.html/` — explain what lives here and when agents should edit it.
...
- `core_logs.txt/` — explain what lives here and when agents should edit it.
- `docker-compose.prod-test.yaml/` — explain what lives here and when agents should edit it.
- `docker-compose.swarm.yaml/` — explain what lives here and when agents should edit it.
- `docker-compose.yml/` — explain what lives here and when agents should edit it.
- `docker-mailhog.yaml/` — explain what lives here and when agents should edit it.
